...
st.caption(
    "Standardized valuation of private sector speaker and moderator contributions "
    "for US APEC–RISE OT5 (PSE-4) reporting."
)
...
category = st.selectbox(
    ...
    help="Final category selection is a staff determination."
)
